...
function MoviePage() {
  return (
    <div className="movieDetails">
      <div className="page-row movieDetails__row">
        ...
        <div className="movieDetails__bookmark">
            ...
            <span className="movieDetails__bookmark__text">Add to Favorites</span>
        </div>
    ...
    <div className="movieDetails__img__wrapper">
      <Image width={0} height={0} sizes={"100vw"} src={"https://m.media-amazon.com/images/M/MV5BMTc5MDE2ODcwNV5BMl5BanBnXkFtZTgwMzI2NzQ2NzM@._V1_QL75_UX190_CR0,0,190,281_.jpg"} alt="" className="movieDetails__img" />
    </div>
    </div>
    </div>
