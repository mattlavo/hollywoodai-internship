      ...
      >
        <div className="w-full h-full sm:w-[400px] sm:h-[640px] bg-white p-8 rounded-[10px] absolute outline-none">
            ...
            <form className="flex flex-col items-end gap-4">
              ...
              <button className="w-full h-11 pt-0 px-5 text-[15px] font-medium rounded-full bg-[#320580] text-white border-none justify-center items-center">Sign Up</button>
            </form>
            <div className="mt-5 text-center text-[13px] flex justify-center gap-1">
              <span className="">Already have an account?</span>
              <span className="underline text-[#4f46e5] cursor-pointer">Log In</span>
            </div>
        </div>
      </Modal>
    </>
